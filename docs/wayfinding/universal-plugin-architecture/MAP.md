...
- [Face Agent Python Host & Opt-In Degradation Contract](tickets/005-face-agent-python-host-contract.md) — WITHDRAWN with the Face Agent removal (see runtime/linux/docs/adr/0004-p4-generic-uvc-camera.md); kept as exploration history.
