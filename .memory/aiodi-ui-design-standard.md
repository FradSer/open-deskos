...
**规则：**
- token 修改必须同步 `research/esp32-p4-c6-deskos/firmware/components/lua_modules/lua_module_lvgl/lib/aiodi.lua`、`aiodi.md`、`application/edge_agent/main/cerb_voice_ui.c` 和 `sim/native_sdl/sim_voice_ui.c`；后两个文件的 system prompt 与 palette 白名单必须逐字一致。
