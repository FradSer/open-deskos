                ...
                <div class="flex flex-col gap-3 pt-2">
                  ...
                  >
                    <textarea
                      ...
                      class={[
                        'w-full min-h-[220px] rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-bg-input)] p-3 text-[0.88rem] leading-6 font-mono text-[var(--color-text-primary)] focus:outline-none focus:border-[rgba(235, 87, 87,0.4)]',
