...
const variantClasses: Record<Variant, string> = {
  primary:
    'bg-[var(--color-accent)] text-[var(--color-text-on-accent)] shadow-[0_0_20px_rgba(235, 87, 87,0.1)] hover:enabled:shadow-[0_0_28px_rgba(235, 87, 87,0.18)] hover:enabled:opacity-90',
  secondary:
