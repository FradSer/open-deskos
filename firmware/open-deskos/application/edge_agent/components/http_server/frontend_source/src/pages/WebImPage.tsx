  ...
  return (
    <TabShell class="flex h-[calc(100dvh-5.5rem)] min-h-[520px] flex-col sm:h-[calc(100dvh-6.5rem)]">
      <PageHeader
        ...
        actions={
          <Show when={wsReady()}>
            <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[rgba(52, 199, 89,0.2)] bg-[var(--color-green-dim)] text-[var(--color-green)] text-[0.78rem] font-medium">
                ...
                <p
                  class={[
                    ...
                    !wsReady()
                      ...
                      : 'border-[rgba(52, 199, 89,0.2)] bg-[var(--color-green-dim)] text-[var(--color-green)]',
                  ].join(' ')}
                >
