          ...
          <input
            ...
            class={[
              ...
              local.error
                ...
                : 'border-[var(--color-border-subtle)] focus:border-[rgba(235, 87, 87,0.4)]',
    ...
    >
      {({ id }) => (
        <select
          ...
          {...rest}
          class={[
            'w-full rounded-[var(--radius-sm)] border border-[var(--color-border-subtle)] bg-[var(--color-bg-input)] px-3 py-2 text-sm text-[var(--color-text-primary)] transition focus:border-[rgba(235, 87, 87,0.4)]',
            local.inputClass ?? '',
          ]
            .filter(Boolean)
            .join(' ')}
    ...
    >
      {({ id }) => (
        <textarea
          ...
          {...rest}
          class={[
            'w-full min-h-[200px] rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-bg-input)] px-4 py-3 text-[0.88rem] leading-6 text-[var(--color-text-primary)] transition font-mono focus:border-[rgba(235, 87, 87,0.4)]',
            local.inputClass ?? '',
          ]
            .filter(Boolean)
            .join(' ')}
