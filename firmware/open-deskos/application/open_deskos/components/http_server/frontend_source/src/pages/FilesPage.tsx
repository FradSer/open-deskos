    ...
    >
      <div class="p-5 flex flex-col gap-3">
        ...
        <textarea
          ...
          class="w-full min-h-[420px] rounded-[var(--radius-md)] border border-[var(--color-border-subtle)] bg-[var(--color-bg-input)] p-4 text-[0.88rem] leading-6 font-mono text-[var(--color-text-primary)] focus:outline-none focus:border-[rgba(235, 87, 87,0.4)]"
