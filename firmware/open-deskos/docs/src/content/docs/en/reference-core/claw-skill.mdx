...
1. <LinkToSource relativePath="application/open_deskos/fatfs_image/skills/" />: app-bundled factory Skills laid out as `skills/<skill_id>/SKILL.md`, copied into the build staging image.
...
Note: <LinkToSource relativePath="application/open_deskos/fatfs_image/" /> is source input. `application/open_deskos/build/fatfs_image/` is generated staging output and is recreated during the build.
