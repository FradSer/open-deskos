...
At this point, you should already have a Guition JC4880P443C board prepared.
Open DeskOS firmware supports only this ESP32-P4 + ESP32-C6, 480×800 production target.
