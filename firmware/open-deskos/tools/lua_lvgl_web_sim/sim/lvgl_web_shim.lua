...
-- Mirror firmware lvgl.SYMBOL (FontAwesome UTF-8). Values are placeholders
-- in the web sim; device uses real LV_SYMBOL_* strings.
lvgl.SYMBOL = {
    bullet = "•", audio = "♪", video = "▶", list = "≡", ok = "✓", close = "✕",
    power = "⏻", settings = "⚙", home = "⌂", download = "↓", drive = "💾",
    refresh = "↻", mute = "🔇", volume_mid = "🔊", volume_max = "🔊",
    image = "🖼", tint = "💧", prev = "⏮", play = "▶", pause = "⏸", stop = "⏹",
    next = "⏭", eject = "⏏", left = "◀", right = "▶", plus = "+", minus = "-",
    eye_open = "👁", eye_close = "−", warning = "⚠", shuffle = "⇄", up = "▲",
    down = "▼", loop = "↻", directory = "📁", upload = "↑", call = "☎",
    cut = "✂", copy = "⎘", save = "💾", bars = "☰", envelope = "✉",
    charge = "⚡", paste = "📋", bell = "🔔", keyboard = "⌨", gps = "⌖",
    file = "📄", wifi = "📶", battery_full = "🔋", battery_3 = "🔋",
    battery_2 = "🔋", battery_1 = "🔋", battery_empty = "🪫", usb = "USB",
    bluetooth = "BT", trash = "🗑", edit = "✎", backspace = "⌫",
    sd_card = "SD", new_line = "↵",
}
lvgl.PANEL_IF_IO = 0
lvgl.PANEL_IF_RGB = 1
lvgl.PANEL_IF_MIPI_DSI = 2
