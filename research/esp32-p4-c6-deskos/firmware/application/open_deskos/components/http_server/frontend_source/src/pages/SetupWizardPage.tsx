...
export const SetupWizardPage: Component<SetupWizardPageProps> = (props) => {
  ...
  return (
    <div class="min-h-screen bg-[radial-gradient(circle_at_top,rgba(235, 87, 87,0.12),transparent_36%),linear-gradient(180deg,#171717_0%,#0a0a0a_100%)]">
                  ...
                  <div
                    class={[
                      ...
                      index() === step()
                        ...
                        : index() < step()
                          ? 'border-[rgba(52, 199, 89,0.22)] bg-[rgba(52, 199, 89,0.08)]'
