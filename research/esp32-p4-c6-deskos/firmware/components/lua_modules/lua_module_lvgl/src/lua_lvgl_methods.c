...
static const luaL_Reg lua_lvgl_base_methods[] = {
    ...
    {"get_coords", lua_lvgl_get_coords},
    {"set_frame", lua_lvgl_set_frame},
    {"set_transform", lua_lvgl_set_transform},
    {"set_clickable", lua_lvgl_set_clickable},
    {"reparent", lua_lvgl_reparent},
    ...
    {"set_scroll_snapshot_layers", lua_lvgl_set_scroll_snapshot_layers},
    {"get_scroll", lua_lvgl_get_scroll},
    {"scroll_to", lua_lvgl_scroll_to},
    {"on", lua_lvgl_obj_on},
...
static const luaL_Reg lua_lvgl_screen_methods[] = {
    ...
    {"load_anim", lua_lvgl_screen_load_anim},
    {NULL, NULL},
};
...
static const luaL_Reg lua_lvgl_arc_methods[] = {
    ...
    {"get_value", lua_lvgl_get_value},
    {"set_range", lua_lvgl_set_range},
    {"set_bg_angles", lua_lvgl_set_arc_bg_angles},
    {NULL, NULL},
};
