...
local ok, err = pcall(function()
    ...
    local advance, box_w, box_h, offset_x, offset_y, base_line = font24:glyph_bounds("A")
    assert(advance > 0 and box_w > 0 and box_h > 0)
    assert(type(offset_x) == "number" and type(offset_y) == "number" and base_line >= 0)
