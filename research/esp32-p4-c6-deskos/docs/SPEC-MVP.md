...
| D: 转 CM5/S31 迁移分支 | 停止在 P4+C6 规格内继续加回退；另见 [CM5/S31 experiment](../../../experiments/cm5-s31-gateway/README.md) | RK3588S 直接联网与 S31 host protocol 独立验证，不把 S31 当作已兼容的 esp-hosted slave |
