...
Deploying color once the system exists: meaning, emphasis, gradients and appearance variants. For picking values see [palette-generation.md](better-colors-palette-generation.md), for naming them [token-naming.md](better-colors-token-naming.md), for checking pairs [contrast.md](better-colors-contrast.md).
...
The role inventory in [token-naming.md](better-colors-token-naming.md) is the list of roles a system needs.
...
Every custom color needs a light and a dark variant, derived per [palette-generation.md](better-colors-palette-generation.md). Beyond that, users who enable increased contrast expect visibly stronger differentiation:
