...
Staged entrances and the exits that follow them. For interactive state feedback see [animations.md](better-ui-animations.md); for icon swaps see [icon-transitions.md](better-ui-icon-transitions.md).
