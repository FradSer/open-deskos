...
Interruptible transitions, press feedback and the restraint that decides whether to animate at all. Staged entrances and exits live in [enter-exit.md](better-ui-enter-exit.md); icon swaps in [icon-transitions.md](better-ui-icon-transitions.md).
